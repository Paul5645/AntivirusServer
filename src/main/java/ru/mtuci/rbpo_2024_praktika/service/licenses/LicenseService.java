...
public class LicenseService {
    ...
    public ResponseEntity<?> createLicense(LicenseCreateDto licenseDto){
        ...
        String historyDescription = "A new license was created at " + new Date() + "by user with ID" + licenseDto.getOwnerId().toString();
        licenseHistoryService.recordLicenseChange(license,owner.get(),"Created",historyDescription);
